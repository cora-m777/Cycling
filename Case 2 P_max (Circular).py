...
T_highlight = np.where(F_Circular >= 1000.0, T_Circular, np.nan)  # Use np.nan to not plot points below 1000
F_highlight = np.where(F_Circular >= 1000.0, F_Circular, np.nan)  # Use np.nan to not plot points below 1000
...
F_highlight = np.where(np.abs(F_Circular-1000)<=Epsilon, np.zeros((1000,1000)),255* np.ones((1000,1000)))  # Use np.nan to not plot points below 1000
