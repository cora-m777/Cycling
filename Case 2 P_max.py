...
Phis = np.linspace(0, np.pi/18, 2000)
Ps = np.linspace(550, 1600, 2000)
...
ax.set_title('Time as a Function of P_max (Linear)', fontsize=20)
...
ax.set_title('Fatigue as a Function of P_max (Linear)', fontsize=20)
...
F_highlight = np.where(np.abs(F_linear-2000)<=Epsilon, np.zeros((2000,2000)),255* np.ones((2000,2000)))  # Use np.nan to not plot points below 1000
